...
<body>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    // Initialize Three.js after loading screen is gone
                    initThreeJS();
        ...
        // Call Anthropic API through backend
        ...
        // Global variable to track typewriter
        ...
        function typewriterEffect(element, text, speed = 15) {
            ...
            // Completely clear and reset the element
            element.innerHTML = '';
            element.textContent = '';
        ...
        function showInfoModal(type) {
            ...
            switch(type) {
                case 'vision':
                    ...
                    description = 'Prepare for the impossible.\n\n2027:\nYour iCompanion becomes your home brain - controlling every device with a single glance, predicting your needs hours before you have them, and creating personalized environments that adapt in real-time to your emotions.\n\n2028:\nRevolutionary health breakthrough - your iCompanion detects health issues weeks before symptoms appear through micro-expressions, voice patterns, and behavioral changes.\n\n2029:\nTransform into a productivity powerhouse - attend meetings as a holographic presence, have your iCompanion negotiate deals while you sleep, and watch it manage entire business operations autonomously.\n\n2030:\nThe ultimate financial revolution - your iCompanion becomes your personal financial advisor, analyzing market sentiment and viral social media trends to recommend smart investments in stocks, crypto, and emerging memecoins.\n\nThis is not just technology. This is human potential unleashed, making millionaires out of ordinary people.';
                    break;
                case 'companion':
                    title.textContent = 'iCompanion';
                    description = 'Introducing the future of personal computing. iCompanion redefines what it means to have an AI companion.\n\nOur revolutionary tabletop companion features an advanced visual personality with an animated Finder-inspired interface, powered by next-generation Siri technology.\n\nComing 2027, this is not just another device. It is your intelligent companion, designed to be as natural and intuitive as human conversation itself.';
                    break;
                case 'support':
                    title.textContent = 'Support';
                    description = 'Add your Support description here.';
                    break;
            }
